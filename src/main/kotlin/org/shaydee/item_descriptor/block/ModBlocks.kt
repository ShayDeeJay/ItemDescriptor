package org.shaydee.item_descriptor.block

import org.shaydee.item_descriptor.ItemDescriptor
...
object ModBlocks {
    val REGISTRY = DeferredRegister.createBlocks(ItemDescriptor.ID)
